					...
					<div class="body-wrapper card-body">
					  ...
					  <form class="password-form" @submit.prevent="updatePassword()">
					  	...
					  	<div class="form-group">
					  		...
					  		<label for="ch_password" class="app-bolder-text">Change Password</label>
					    ...
					    <div class="form-group">
					    	...
					    	<label for="comfirm_password" class="app-bolder-text">Confirm Password</label>
					    ...
					    <div class="info-wrapper">
						  ...
						  <div class="form-group">
					    	...
					    	<label for="comfirm-password" class="app-bolder-text">Current Password</label>
					    ...
					    <div class="pl-4 pr-4">
					    	...
					    	<center>
					    		<button class="btn btn-lg btn-info btn-block">
					    			...
					    			<div class="spinner-grow text-success spinner-grow-sm" role="status" aria-hidden="true" v-if="password.loading"></div>
